...
You can specify the text indentation by using a numeric value correspinding to value as pixels (0 ~ px(0); 1 ~ px(30); 2 ~ px(60)). A dedicated function is implemented: `indent_table()`.
