...
In this example, we add `sort = TRUE`, which orders the categories of categorical variables in descending order based on their counts.
...
The values passed can be a single integer or a vector of integers. If a single integer or a vector is passed, it recycled to the length of the number of statistics presented.
