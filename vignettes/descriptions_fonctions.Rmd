---
title: "Hello World Vignette"
author: "Your Name"
date: "`r Sys.Date()`"
output: rmarkdown::html_document
vignette: >
  %\VignetteIndexEntry{Hello World Vignette}
  %\VignetteEngine{knitr::rmarkdown}
---

# Introduction

This vignette demonstrates how to use the `hello_world` function from the `HelloWorld` package.

# Usage

To get started, first load the `HelloWorld` package:
...
Now you can use the hello_world function to print "Hello, World!" to the console:
