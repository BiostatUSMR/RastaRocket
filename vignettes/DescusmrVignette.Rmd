...
In this example, we're just going to change the DM = ‘ALL’ option to DM = ‘tri’. 
...
A ungrouped description by sorting the characteristics of the categorical variables in descending order
...
A ungrouped description of the variables by removing the variables with zero modality. 
