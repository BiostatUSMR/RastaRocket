...
#'
#' @param tbls A list of descriptive tables (generated by `Descusmr::desc_var` or similar functions).
...
#'   Descusmr::desc_var(table_title = "Demographics", group = FALSE)
#'
#' tb2 <- data %>%
#'   dplyr::select(quatre_modalites) %>%
#'   Descusmr::desc_var(table_title = "Modalities", group = FALSE)
#'
