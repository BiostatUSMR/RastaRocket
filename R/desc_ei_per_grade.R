...
#' @param ei_grdm_col column corresponding to EIGRDM.
#' @param ei_grav_col column corresponding to EIGRAV.
...
desc_ei_per_grade <- function(df_pat_grp,
  ...
  # }
  #MS
  # if(any(!c(rlang::as_string(id_col), "EIGRDM", "EINUM") %in% colnames(df_pat_grade))){
  #   stop(glue::glue("df_pat_grade should contain '{rlang::as_string(id_col)}' = the patient id, 'EIGRDM' = the AE grade, and 'EINUM' = the AE id"))
  # }
